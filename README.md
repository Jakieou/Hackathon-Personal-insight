...
This project studies the relationship between government policy, public trust, and real-world outcomes, with a focus on identifying and understanding the mismatch (gap) between policy actions and public perception.

Rather than analyzing policy effectiveness or trust separately, this project emphasizes whether policy and public trust adjust synchronously, and what happens when they do not.
